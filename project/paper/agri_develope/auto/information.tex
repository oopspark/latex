...
\newcommand{\maintitleline}{세계 콩 무역 네트워크의 구조적 변화와 \\[10pt] 한국 식량안보에 대한 함의} % title.main

\newcommand{\maintitle}{세계 콩 무역 네트워크의 구조적 변화와 한국 식량안보에 대한 함의} % title.main
\newcommand{\subtitle}{2023년 무역 구조 기반 복잡계 네트워크 분석을 중심으로} % title.sub
...
\newcommand{\chapterfour}{2023년 콩 무역 네트워크 분석 결과} % toc.chapterthree
\newcommand{\chapterfive}{시나리오 분석의 확장과 한국적 함의: 2020년과 2023년의 비교} 
\newcommand{\chaptersix}{정책적 시사점 및 결론: 네트워크 관점에서 본 한국의 선택지} 


\newcommand{\chapterfourtoc}{2023년 콩 무역 네트워크 분석 결과} % toc.chapterthree
