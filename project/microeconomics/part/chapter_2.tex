...
\begin{itemize}
    ...
    \item[$\Pi$.5] $\Pi(tp,tw)=t\Pi(p,w), \qquad t>0$\\
    (homogeneous of degree 1 in $(p,w)$)
...
To show convexity, let $(x_2,y_2)$ be the profit-maximizing choice for
\[
(p_2,w_2)=\bigl(\theta p_0+(1-\theta)p_1,\ \theta w_0+(1-\theta)w_1\bigr),
\qquad 0\le \theta \le 1.
\]
Then
\[
\Pi(p_0,w_0)\ge p_0\cdot y_2 - w_0\cdot x_2,
\]
\[
\Pi(p_1,w_1)\ge p_1\cdot y_2 - w_1\cdot x_2.
\]
Therefore,
\[
\theta \Pi(p_0,w_0)+(1-\theta)\Pi(p_1,w_1)
\ge
\Pi(p_2,w_2),
\]
so $\Pi(p,w)$ is convex.
...
\subsection{Illustration of the Duality}
...
\section{Primal vs.\ Dual: Some Dualities}
...
\section{Cost, Revenue and Profit}
